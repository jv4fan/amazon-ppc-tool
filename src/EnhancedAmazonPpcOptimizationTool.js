      ...
      if (file.name.endsWith(".csv")) {
        ...
        Papa.parse(file, {
          ...
          complete: (results) => {
            ...
            if (enhancedMode) {
              // 增强型数据处理
              const enhancedResults = enhancedProcessSearchTermData(results.data);
      ...
      case "advice":
        return enhancedMode ? (
          <EnhancedAdviceTab
            ...
            exportDecisionsToCSV={() => exportDecisionsToCSV(optimizationDecisions)}
          />
        ) : (
          <AdviceTab
            processedData={processedData}
  ...
  return (
    <div className="container">
      <div className="header">
        <h1>亚马逊PPC广告优化工具 {enhancedMode && <span className="enhanced-badge">增强版</span>}</h1>
